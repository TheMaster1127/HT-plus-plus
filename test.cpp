...
char var1[62] = "hello asdfdxg aesdf asdfg cdfxcgvhello asdfdxg aesdf asdfg cd";
variables["var11"] = ;
for (int A_Index1 = 1; A_Index1<= 11; ++A_Index1)
{
variables["A_Index1"] = A_Index1;
variables["var11"] = convertToStr(variables["var11"]) + convertToStr(std::string(var1)) + convertToStr(std::string(var1));
}
variables["var"] = std::string("1");
variables["var1" + convertToStr(variables["var"])] = std::string("sd");
variables["numsss"] = 0;
std::vector<std::string> items2 = LoopParseFunc(convertToStr(std::string(var1)), std::string(" "));
